...
class TabNetRegressor(tf.keras.Model):
    ...
    def __init__(self, feature_columns,
        ...
        self.regressor = tf.keras.layers.Dense(num_regressors, use_bias=False, name='regressor', activation = 'sigmoid')
...
def tabnet_model(feature_columns = None):
    model = TabNet(feature_columns=feature_columns,
                  num_features=676,
                  feature_dim=256,
                  output_dim=64,
    ...
    # models = TabNetRegressor(feature_columns=feature_columns,
    #                          num_regressors=1,
    #                          num_features=88,
    #                          feature_dim=256,
    #                          output_dim=64,
